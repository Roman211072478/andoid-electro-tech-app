...
import com.fiki.roman.andoirdmathlab.dto.PronyBreakDTO;
import com.fiki.roman.andoirdmathlab.dto.ResultDTO;
import com.fiki.roman.andoirdmathlab.factories.chain.factories.prony.breakmethod.PronyBreakCUDChainFactory;
 ...
 */
public class PronyBreakCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public PronyBreakCUDService() {
    ...
    private void runService(Intent intent)
    {
        ...
        PronyBreakDTO pronyBreakDTO;

        ResultReceiver receiver = intent.getParcelableExtra("receiverTag");//send ur receive through
        pronyBreakDTO = (PronyBreakDTO)intent.getSerializableExtra("dtoTag");
        ...
        if(!request.isEmpty())
        {
            String sResult = PronyBreakCUDChainFactory.performRequest(request, pronyBreakDTO,ctx);//returns primary key or -1 for unsuccessFul
