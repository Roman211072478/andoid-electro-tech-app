 ...
 */
public abstract class UserCUDAbstract {
	
	 public UserCUDAbstract nextValue;

    public void setNext(UserCUDAbstract nextValue) {
        this.nextValue = nextValue;
    }
    
    //This function will be overidded to all subClasses
    public abstract String action(String request, UserDTO userDTO, ContextDTO ctx);
