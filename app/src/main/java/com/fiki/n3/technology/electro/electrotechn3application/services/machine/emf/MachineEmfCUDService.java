...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.machine.emf.MachineEmfCUDChainFactory;
 ...
 */
public class MachineEmfCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public MachineEmfCUDService() {
    ...
    private void runService(Intent intent)
    {
        ...
        machineEmfDTO = (MachineEmfDTO)intent.getSerializableExtra("dtoTag");
        ...
        if(!request.isEmpty())
        {
            String sResult = MachineEmfCUDChainFactory.performRequest(request, machineEmfDTO,ctx);//returns primary key or -1 for unsuccessFul
