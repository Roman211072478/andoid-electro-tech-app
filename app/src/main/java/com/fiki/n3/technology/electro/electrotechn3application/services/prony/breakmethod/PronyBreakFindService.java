...
import com.fiki.roman.andoirdmathlab.factories.chain.factories.prony.breakmethod.PronyBreakFindChainFactory;
 ...
 */
public class PronyBreakFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public PronyBreakFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        PronyBreakDTO machineEmfDTO;

        ResultReceiver receiver = intent.getParcelableExtra("receiverTag");//send ur receive through
        machineEmfDTO = (PronyBreakDTO)intent.getSerializableExtra("dtoTag");
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = PronyBreakFindChainFactory.performRequest(request, machineEmfDTO,ctx);
