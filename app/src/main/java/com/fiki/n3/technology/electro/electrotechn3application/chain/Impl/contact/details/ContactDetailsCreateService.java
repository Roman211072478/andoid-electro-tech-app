 ...
 */
public class ContactDetailsCreateService extends ContactDetailsCUDAbstract {
    ...
    public String action(String request, ContactDetailsDTO contactDetailsDTO, ContextDTO ctx) {
        ...
        if(request.equals("create"))
        {
            ...
            Long result = dao.create(contactDetailsDTO.getContactDetails(),contactDetailsDTO.getStaffId());
