 ...
 */
public class ContactDetailUpdateService extends ContactDetailsCUDAbstract {
    ...
    public String action(String request, ContactDetailsDTO contactDetailsDTO, ContextDTO ctx) {
        ...
        if(request.equals("update"))
        {
            ...
            int result = dao.update(contactDetailsDTO.getContactDetails(),contactDetailsDTO.getStaffId());
