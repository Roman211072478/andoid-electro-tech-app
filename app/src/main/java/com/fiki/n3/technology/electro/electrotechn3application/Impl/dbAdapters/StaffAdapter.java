...
public class StaffAdapter extends SQLiteOpenHelper{


    //set table name
    public final static String TABLE_STAFF = "staff";
    ...
    private static final String DATABASE_NAME = dbDetails.getDATABASE_Staff();
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(StaffAdapter.class.getName(),"upgraing the database from Version "+oldVersion
