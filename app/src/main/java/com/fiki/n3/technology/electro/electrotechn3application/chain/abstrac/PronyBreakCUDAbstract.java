 ...
 */
public abstract class PronyBreakCUDAbstract {
	
	 public PronyBreakCUDAbstract nextValue;

    public void setNext(PronyBreakCUDAbstract nextValue) {
        this.nextValue = nextValue;
    }
    
    //This function will be overidded to all subClasses
    public abstract String action(String request, PronyBreakDTO pronyBreakDTO, ContextDTO ctx);
