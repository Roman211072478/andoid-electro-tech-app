 ...
 */
public class StaffCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public StaffCUDService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(!request.isEmpty())
        {
            String sResult = StaffCUDChainFactory.performRequest(request, staffDTO,ctx);//returns primary key or -1 for unsuccessFul
