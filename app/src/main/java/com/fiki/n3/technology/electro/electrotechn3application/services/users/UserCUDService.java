...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.users.UserCUDChainFactory;
 ...
 */
public class UserCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public UserCUDService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(!request.isEmpty())
        {
            String sResult = UserCUDChainFactory.performRequest(request, userDTO,ctx);//returns primary key or -1 for unsuccessFul
