...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.machine.emf.MachineEmfFindChainFactory;
 ...
 */
public class MachineEmfFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public MachineEmfFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = MachineEmfFindChainFactory.performRequest(request, machineEmfDTO,ctx);
