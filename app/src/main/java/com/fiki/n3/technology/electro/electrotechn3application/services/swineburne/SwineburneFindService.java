...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.swineburne.SwineburneFindChainFactory;
 ...
 */
public class SwineburneFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;

    private ContextDTO ctx;
    public SwineburneFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = SwineburneFindChainFactory.performRequest(request, ropeBreakDTO,ctx);
