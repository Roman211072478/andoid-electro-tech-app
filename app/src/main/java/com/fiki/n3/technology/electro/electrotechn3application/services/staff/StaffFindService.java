package com.fiki.n3.technology.electro.electrotechn3application.services.staff;
...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.Staff.StaffFindChainFactory;
 ...
 */
public class StaffFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public StaffFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        staffDTO = (StaffDTO)intent.getSerializableExtra("dtoTag");
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = StaffFindChainFactory.performRequest(request, staffDTO,ctx);
