...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.rope.method.RopeBreakFindChainFactory;
 ...
 */
public class RopeBreakFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public RopeBreakFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = RopeBreakFindChainFactory.performRequest(request, ropeBreakDTO,ctx);
