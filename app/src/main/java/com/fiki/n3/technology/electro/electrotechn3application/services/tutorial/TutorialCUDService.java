...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.Tutorial.TutorialCUDChainFactory;
 ...
 */
public class TutorialCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public TutorialCUDService() {

        super("TutorialCUDServices");
    }
    ...
    private void runService(Intent intent)
    {
        ...
        if(!request.isEmpty())
        {
            String sResult = TutorialCUDChainFactory.performRequest(request, tutorialDTO,ctx);//returns primary key or -1 for unsuccessFul
