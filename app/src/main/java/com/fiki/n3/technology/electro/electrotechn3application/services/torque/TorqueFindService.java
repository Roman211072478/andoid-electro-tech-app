...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.torque.TorqueFindChainFactory;
 ...
 */
public class TorqueFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public TorqueFindService() {

        super("TorqueFindServices");
    }
    ...
    private void runService(Intent intent)
    {
        ...
        torqueDTO = (TorqueDTO)intent.getSerializableExtra("dtoTag");
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = TorqueFindChainFactory.performRequest(request, torqueDTO,ctx);
