...
/**
 * Created by Roman on 2016/06/26.
 */
public class PronyBrakeCalculator {

    public PronyBrakeCalculator()
    {}

    public double calculatEfficiency(double speed,double totalTension,
                                     double length,double volts,double amps)
    {
        double outputPower = calculatOutputPower( speed, totalTension, length);
