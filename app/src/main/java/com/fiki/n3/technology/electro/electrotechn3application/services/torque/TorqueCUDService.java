 ...
 */
public class TorqueCUDService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public TorqueCUDService() {

        super("TorqueCUDServices");
    }
    ...
    private void runService(Intent intent)
    {
        ...
        if(!request.isEmpty())
        {
            String sResult = TorqueCUDChainFactory.performRequest(request, torqueDTO,ctx);//returns primary key or -1 for unsuccessFul
