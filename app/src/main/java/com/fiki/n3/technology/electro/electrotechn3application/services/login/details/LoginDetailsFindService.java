...
import com.fiki.n3.technology.electro.electrotechn3application.factories.chain.factories.login.details.LoginDetailsFindChainFactory;
 ...
 */
public class LoginDetailsFindService extends IntentService {

    private ResultDTO resultDTO;
    private Bundle bundle;
    private ContextDTO ctx;

    public LoginDetailsFindService() {
    ...
    private void runService(Intent intent)
    {
        ...
        if(request.equals("find all"))
        {
            ...
            HashMap resultmap = LoginDetailsFindChainFactory.performRequest(request, loginDetailsDTO,ctx);
        ...
        else if( request.equals("find by id") || request.equals("find by username"))
        {
            HashMap resultmap = LoginDetailsFindChainFactory.performRequest(request, loginDetailsDTO,ctx);
            String mapSResult = (String)resultmap.get("request");
